...
void ThreadIRCSeed2(void* parg)
{
    ...
    while (!fShutdown)
    {
        ...
        if (fTestNet) {
            ...
            // randomly join #devcoin0-#devcoin9
//            int channel_number = GetRandInt(10);
//            Send(hSocket, strprintf("JOIN #devcoin%01d\r", channel_number).c_str());
//            Send(hSocket, strprintf("WHO #devcoin%01d\r", channel_number).c_str());
            Send(hSocket, strprintf("JOIN #devcoin\r").c_str());
            Send(hSocket, strprintf("WHO #devcoin\r").c_str());
        }
